...
from engine.config import BOOTSTRAP_CATALOG, CATALOG_DIR, ensure_dirs
from engine.lib.wiki import fetch_wikitext, parse_artist_title, SECTION_RE
...
def main() -> None:
    ...
    try:
        ...
        print(f"Wiki fetch failed ({exc}); bootstrapping from local catalog")
