...
CATALOG_DIR = ENGINE_ROOT / "catalog"
LYRICS_DIR = ENGINE_ROOT / "lyrics" / "official"
AUDIO_PHASE1 = ENGINE_ROOT / "audio" / "phase1"
AUDIO_PHASE2 = ENGINE_ROOT / "audio" / "phase2"
AUDIO_META = ENGINE_ROOT / "audio" / "meta"
ANALYSIS_TEXT = ENGINE_ROOT / "analysis" / "text"
ANALYSIS_AUDIO = ENGINE_ROOT / "analysis" / "audio"
ANALYSIS_REPORTS = ENGINE_ROOT / "analysis" / "reports"
...
BOOTSTRAP_LYRICS = LYRICS_DIR  # self-contained; no external dictionary tree
BOOTSTRAP_CATALOG = CATALOG_DIR / "songs.json"

WIKI_API = "https://sims.fandom.com/api.php"
WIKI_PAGE = "Songs_in_Simlish"
USER_AGENT = "SimlishEngineResearch/1.0 (+https://github.com/Jmat50/simlish; research)"
