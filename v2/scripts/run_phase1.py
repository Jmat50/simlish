...
STAGES = [
    "v2/scripts/01_fetch_official_catalog.py",
    "v2/scripts/02_fetch_official_parallel_lyrics.py",
    "v2/scripts/03_resolve_youtube_official.py",
    "v2/scripts/04_download_audio.py",
    "v2/scripts/05_analyze_text_parallel.py",
    "v2/scripts/06_align_audio_to_lyrics.py",
    "v2/scripts/07_analyze_audio_prosody.py",
    "v2/scripts/08_induce_rules_and_stats.py",
    "v2/scripts/09_train_phrase_model.py",
    "v2/scripts/10_build_converter.py",
    "v2/scripts/11_eval_and_report.py",
]
